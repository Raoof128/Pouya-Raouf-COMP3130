...
class EnvConfig {
  ...
  static const String _devSupabaseUrl = 'https://cxsqlgvbwtevkkljzolg.supabase.co';
  ...
  static const String _devGoogleMapsApiKey = 'AIzaSyD9WlnjQntUsWNzHR2oa-P-8zG3l60D2SA';

  /// Supabase project URL. Falls back to dev project in debug mode.
  static String get supabaseUrl =>
      _supabaseUrl.isNotEmpty ? _supabaseUrl : (kDebugMode ? _devSupabaseUrl : '');

  /// Supabase anonymous key (public, RLS-enforced). Falls back to dev key in debug mode.
  static String get supabaseAnonKey =>
      _supabaseAnonKey.isNotEmpty ? _supabaseAnonKey : (kDebugMode ? _devSupabaseAnonKey : '');

  /// Google Maps client-side API key. Falls back to dev key in debug mode.
  static String get googleMapsApiKey =>
      _googleMapsApiKey.isNotEmpty ? _googleMapsApiKey : (kDebugMode ? _devGoogleMapsApiKey : '');

  /// App environment. Defaults to 'development'.
  static String get appEnv =>
      _appEnv.isNotEmpty ? _appEnv : 'development';
